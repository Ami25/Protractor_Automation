...
describe('SAMPLE TEST', () => {
    ...
    beforeEach(function () {
        ...
        //sbrowser.ignoreSynchronization = true;
    });
    ...
    it('testcase_ExcelData', async () => {
        //console.log('sheetName', constantData.sheetName1 + " FilePath", constantData.filePath)
        var flag = false;
        var testdata = excelData.readData(constantData.sheetName2, constantData.filePath);
